...
// EDIT: Move length calculations out of functions
...
var saucesLength = pizzaIngredients.sauces.length;
var crustsLength = pizzaIngredients.crusts.length;

// Generates random numbers for getAdj and getNoun functions and returns a new pizza name
function generator(adj, noun) {
  var adjectives = getAdj(adj);
  var nouns = getNoun(noun);
  var randomAdjective = parseInt(Math.random() * adjectivesLength);
...
function randomName() {
  var randomNumberAdj = parseInt(Math.random() * adjectivesLength);
  var randomNumberNoun = parseInt(Math.random() * nounsLength);
...
// EDIT: Moved randomPizzaContainer width/height settings to style.css
...
var resizePizzas = function(size) { 
  ...
  // EDIT: Moved calculations out of loop and reduced to only one querySelectorAll call
...
// EDIT: Moved pizzasDiv definition to outside of loop.
...
function updatePositions() {
  ...
  // EDIT: Moved document.body.scrollTop out of loop
...
// EDIT: Reduced number of generated pizzas.
// EDIT: Made sized version of pizza image and removed height/width styles.
// EDIT: Removed width style from mover in style.css.
